...
def write_audit(
    ...
    lines = [
        ...
        "",
        "This standalone realized-price Figure 3 equivalent is rebuilt from the primary",
        ...
        "but the stacked original-versus-optimized totals are recomputed from the realized-price",
