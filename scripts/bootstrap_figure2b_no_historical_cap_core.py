...
OUT_DIR = DATA_DIR / "figure2b_no_historical_cap_core_whiskers"
...
OUT_ITERATIONS = OUT_DIR / "figure2b_no_historical_cap_core_whiskers_iterations.csv"
OUT_SUMMARY = OUT_DIR / "figure2b_no_historical_cap_core_whiskers_summary.csv"
OUT_REPRO = OUT_DIR / "figure2b_no_historical_cap_core_deterministic_reproduction_check.csv"
OUT_AUDIT = OUT_DIR / "figure2b_no_historical_cap_core_whiskers_audit.md"
OUT_PNG = FIG_DIR / "figure2b_no_historical_cap_core_with_whiskers.png"
OUT_PDF = FIG_DIR / "figure2b_no_historical_cap_core_with_whiskers.pdf"
...
def run_bootstrap(
    ...
    for iteration in range(iterations):
        ...
        for scenario in ["Water based", "Nitrogen based"]:
            ...
            for season, context in contexts.items():
                n_rate_iter, p_rate_iter, water_rate_iter = drawn_by_season[season]
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Add traceable whiskers to the approved Figure 2(b) panel."
    )
