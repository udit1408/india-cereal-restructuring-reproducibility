...
OUT_DIR = ROOT / "data" / "generated" / "final_paper_figure_sync"
OUT_JSON = OUT_DIR / "final_paper_figure_sync_report.json"
OUT_MD = OUT_DIR / "final_paper_figure_sync_report.md"
...
def build_report() -> dict[str, object]:
    ...
    specs = [
        (
            ...
            [ARTICLE_DIR / "fig1.pdf"],
        ),
        (
            "Figure 2",
            ROOT / "figures" / "working_variants" / "Figure2_equivalent.pdf",
            [
                ROOT / "figures" / "manuscript_final" / "fig2_main_revision2.pdf",
                ROOT / "R_2_PDFs" / "fig2_main_revision2.pdf",
                ARTICLE_DIR / "fig2_main_revision2.pdf",
                ARTICLE_DIR / "fig2_t_r2.pdf",
            ],
        ),
        (
            "Figure 2 PNG",
            ROOT / "figures" / "working_variants" / "Figure2_equivalent.png",
            [ROOT / "figures" / "manuscript_final" / "fig2_main_revision2.png"],
        ),
        (
            "Figure 3",
            ROOT / "figures" / "working_variants" / "Figure3_equivalent.pdf",
            [
                ROOT / "figures" / "manuscript_final" / "figure3_clean_preview.pdf",
                ARTICLE_DIR / "fig3_1.pdf",
            ],
        ),
        (
            "Figure 3 PNG",
            ROOT / "figures" / "working_variants" / "Figure3_equivalent.png",
            [ROOT / "figures" / "manuscript_final" / "figure3_clean_preview.png"],
        ),
    ]
