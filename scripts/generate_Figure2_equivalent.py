...
def _write_panel_b_bootstrap_audit(
    *,
    ...
    lines = [
        ...
        "",
        f"This bootstrap adds whiskers to the primary Figure 2(b) rebuild built with the hybrid {scenario_year} realized-price benchmark.",
...
def _write_audit(
    *,
    ...
    lines = [
        ...
        "",
        f"This standalone figure reruns all Figure 2 panels on the primary no-hard-cap branch using the hybrid {scenario_year} revenue benchmark instead of the district MSP benchmark.",
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        help="Realized-price benchmark year to apply in the hybrid price replacement (default: 2017-18).",
    )
    parser.add_argument(
