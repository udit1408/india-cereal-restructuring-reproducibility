...
| `Fig2a_pareto` | Figure 2a Pareto frontier points | 101 | 31 | `csv/Fig2a_pareto.csv` | `data/generated/figure2_main/figure2_main_panel_a_combined_by_alpha.csv` |
| `Fig2b_values` | Figure 2b deterministic endpoint values | 20 | 6 | `csv/Fig2b_values.csv` | `data/generated/figure2_main/figure2_main_panel_b_values.csv` |
| `Fig2b_whiskers` | Figure 2b whisker summary | 20 | 14 | `csv/Fig2b_whiskers.csv` | `data/generated/figure2_main/panel_b_bootstrap/figure2_main_panel_b_bootstrap_summary.csv` |
| `Fig2c_retention` | Figure 2c retention-constraint sweep | 11 | 10 | `csv/Fig2c_retention.csv` | `data/generated/figure2_main/figure2_main_panel_c_combined.csv` |
| `Fig2d_flows` | Figure 2d crop-transition flows | 36 | 4 | `csv/Fig2d_flows.csv` | `data/generated/figure2_main/figure2_main_panel_d_transition_long.csv` |
| `Fig2d_areas` | Figure 2d optimized area table | 4247 | 6 | `csv/Fig2d_areas.csv` | `data/generated/figure2_main/figure2_main_panel_d_optimized_areas.csv` |
...
| `Fig3a_state_area` | Figure 3a displayed state totals | 81 | 7 | `csv/Fig3a_state_area.csv` | `data/generated/figure3_main/figure3_main_panel_a_display_states.csv` |
| `Fig3b_edges` | Figure 3b alternative-cereal trade edges | 988 | 8 | `csv/Fig3b_edges.csv` | `data/generated/figure3_main/figure3_main_panel_b_alt_trade_edges.csv` |
| `Fig3b_nodes` | Figure 3b alternative-cereal node flows | 32 | 2 | `csv/Fig3b_nodes.csv` | `data/generated/figure3_main/figure3_main_panel_b_alt_node_flows.csv` |
| `Fig3c_edges` | Figure 3c rice-wheat trade edges | 1260 | 5 | `csv/Fig3c_edges.csv` | `data/generated/figure3_main/figure3_main_panel_c_rw_trade_edges.csv` |
| `Fig3c_nodes` | Figure 3c rice-wheat node flows | 36 | 2 | `csv/Fig3c_nodes.csv` | `data/generated/figure3_main/figure3_main_panel_c_rw_node_flows.csv` |
| `FigS16a_ratio` | Supplementary Figure S16a realized price / MSP ratios | 6 | 6 | `csv/FigS16a_ratio.csv` | `data/generated/state_median_unit_price_to_msp_ratio_2014_15_to_2018_19.csv` |
...
| `FigS18a_state_cmp` | Supplementary Figure S18a MSP comparison state areas | 81 | 7 | `csv/FigS18a_state_cmp.csv` | `data/generated/figure3a_state_area_comparison/figure3a_state_area_comparison_display_states.csv` |
| `FigS18b_edges_cmp` | Supplementary Figure S18b MSP comparison alt-cereal edges | 989 | 14 | `csv/FigS18b_edges_cmp.csv` | `data/generated/figure3_trade_networks/figure3b_alt_trade_edges_clean.csv` |
| `FigS18b_nodes_cmp` | Supplementary Figure S18b MSP comparison alt-cereal nodes | 32 | 2 | `csv/FigS18b_nodes_cmp.csv` | `data/generated/figure3_trade_networks/figure3b_alt_node_flows_clean.csv` |
| `FigS18c_edges_cmp` | Supplementary Figure S18c MSP comparison rice-wheat edges | 1260 | 5 | `csv/FigS18c_edges_cmp.csv` | `data/generated/figure3_trade_networks/figure3c_rice_wheat_trade_edges_clean.csv` |
| `FigS18c_nodes_cmp` | Supplementary Figure S18c MSP comparison rice-wheat nodes | 36 | 2 | `csv/FigS18c_nodes_cmp.csv` | `data/generated/figure3_trade_networks/figure3c_rice_wheat_node_flows_clean.csv` |
| `FigS20_frontier` | Supplementary Figure S20 realized-price frontier envelope summary | 101 | 19 | `csv/FigS20_frontier.csv` | `data/generated/figure2_main_frontier_bootstrap/figure2_main_frontier_bootstrap_summary.csv` |
